...
public class ShopUIPopupController : BaseUIElement<ShopItemUIObject>
{
    ...
    public override void UpdateUI(ShopItemUIObject primaryData)
    {
    ...
    protected override bool ClearedIfEmpty(ShopItemUIObject newData)
    {
        if (newData == null)
        {
